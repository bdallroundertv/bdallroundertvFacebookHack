#!usr
# -*- coding: UTF-8 -*-
# mod by: Md Tarjim Ahmed Sharif
# team: BD Allrounder TV
...
def banner():
    ...
    print GG+"  √=================👹👹👹👹============================√"
    print WW+"  | 👉👉Mod by Md Tarjim Ahmed Sharif👈👈  |"
    print GL+"  |       BD Allrounder TV      |"
    print WW+"  |            👹👹👹FACEBOOK: www.facebook.com/mustafiz.sharif.1 👹👹👹            |"
    print Y+"  |             🔱🔱Youtube Channel: BD Allrounder TV🔱🔱              |"
    print GL+"  |👹👹👹👉👹👹👹👹👹👈👹👹👹👹|"
...
♥♥♥♥♥♥♥♥
 ...
 ____   ___         ____  _      _      ____   ___   __ __  ____   ___      ___  ____       ______  __ __ 
|    \ |   \       /    || |    | |    |    \ /   \ |  |  ||    \ |   \    /  _]|    \     |      ||  |  |
|  o  )|    \     |  o  || |    | |    |  D  )     ||  |  ||  _  ||    \  /  [_ |  D  )    |      ||  |  |
|     ||  D  |    |     || |___ | |___ |    /|  O  ||  |  ||  |  ||  D  ||    _]|    /     |_|  |_||  |  |
|  O  ||     |    |  _  ||     ||     ||    \|     ||  :  ||  |  ||     ||   [_ |    \       |  |  |  :  |
|     ||     |    |  |  ||     ||     ||  .  \     ||     ||  |  ||     ||     ||  .  \      |  |   \   / 
|_____||_____|    |__|__||_____||_____||__|\_|\___/  \__,_||__|__||_____||_____||__|\_|      |__|    \_/  
...
print ("BD Allrounder TV--The Total Package.")
print ("Founder-MD Tarjim Ahmed Sharif, CEO-BD Allrounder TV")
raw_input("\n\033[1;96m[\033[1;97mBack\033[1;96m]")
